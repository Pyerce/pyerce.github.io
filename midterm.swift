...
//  Edited and completed by Pierce Findlay on 03/23/2020
...
var str3: String = "4e2d"
var str4: String = "570d"
print(str.utf8)
print(str.unicodeScalars)
print(str3.unicodeScalars)
print(str4.unicodeScalars)
print("\n\n")
...
let string1 = "cal state fullerton"
...
var myString = "sUpErcAlifragilisticexpialadotiOUs"
myString = myString.lowercased()
let replaced = String(myString.map {
    vowels.contains($0) ? Character("Z") : $0
})
print(replaced)
...
let string2 = "__add__"
print("String is \(sadd)")
if string2.hasPrefix(pre) { // true
    print("String has prefix __")
}

if string2.hasSuffix(sadd) { // true
    print("String has suffix __")
}
